...
func (x *ChannelRequest) GetRequest() isChannelRequest_Request {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *ChannelRequest) GetChannelEvent() *ChannelEvent {
	if x != nil {
		if x, ok := x.Request.(*ChannelRequest_ChannelEvent); ok {
...
func (x *ChannelRequest) GetChannelEventAck() *ChannelEventAck {
	if x != nil {
		if x, ok := x.Request.(*ChannelRequest_ChannelEventAck); ok {
...
func (x *ChannelRequest) GetTopicSubscriptionRequest() *TopicSubscriptionRequest {
	if x != nil {
		if x, ok := x.Request.(*ChannelRequest_TopicSubscriptionRequest); ok {
...
func (x *ChannelRequest) GetTopicUnsubscriptionRequest() *TopicUnsubscriptionRequest {
	if x != nil {
		if x, ok := x.Request.(*ChannelRequest_TopicUnsubscriptionRequest); ok {
...
func (x *ChannelResponse) GetResponse() isChannelResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *ChannelResponse) GetConnectAck() *ConnectAck {
	if x != nil {
		if x, ok := x.Response.(*ChannelResponse_ConnectAck); ok {
			return x.ConnectAck
		}
	}
	return nil
...
func (x *ChannelResponse) GetChannelEvent() *ChannelEvent {
	if x != nil {
		if x, ok := x.Response.(*ChannelResponse_ChannelEvent); ok {
			return x.ChannelEvent
		}
	}
	return nil
...
func (x *ChannelResponse) GetChannelEventAck() *ChannelEventAck {
	if x != nil {
		if x, ok := x.Response.(*ChannelResponse_ChannelEventAck); ok {
			return x.ChannelEventAck
		}
	}
	return nil
...
func (x *ChannelResponse) GetTopicSubscriptionRequestAck() *TopicSubscriptionRequestAck {
	if x != nil {
		if x, ok := x.Response.(*ChannelResponse_TopicSubscriptionRequestAck); ok {
...
func (x *ChannelResponse) GetTopicUnsubscriptionRequestAck() *TopicUnsubscriptionRequestAck {
	if x != nil {
		if x, ok := x.Response.(*ChannelResponse_TopicUnsubscriptionRequestAck); ok {
...
type ResponseStatus struct {
	...
	Message map[string]string `protobuf:"bytes,3,rep,name=message,proto3" json:"message,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
